...
\begin{block}{Tech Stack}
  ...
  We deliver a client application that interfaces with the user's safe launcher --
  the portal to the SafeNET. Therefore our tech stack is comprised mostly of front-end
  development tools.

  \par

  We shipped our application using Electron, an open-source framework that allows
  development of desktop applications using HTML, CSS, and Javascript. By using Electron,
  we can automatically port our application to Windows, OS X, and Linux with no change
  to our code. Our user-interface
  was built using React, another open-source javascript framework. Lastly, our
  client business logic was written in Typescript, an open-source programming language
  that adds static typing and object-oriented programming features to javascript.

  \begin{figure}
  \includegraphics[width=0.6\linewidth]{electron.png}
  \end{figure}
  ...
  \begin{figure}
    \includegraphics[width=0.5\linewidth]{ts.png}
  \end{figure}
