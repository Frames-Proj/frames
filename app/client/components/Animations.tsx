//
// A file which contains the SVG animation components we might want
//

import * as React from "react";

export function ChasingArrowsLoadingImage() {
    const chasingArrows: string =
        ...
        <g><path fill="#000000" fill-opacity="1"\
        d="M109.25 55.5h-36l12-12a29.54 29.54 0 0 0-49.53 12H18.75A46.04 46.04 0 0 1\
        96.9 31.84l12.35-12.34v36zm-90.5 17h36l-12 12a29.54 29.54 0 0 0\
